                ...
                <div class="form-horizontal tot-modal-form panel-body">
                    ...
                    <div v-else-if="attendee['Owner or Trainer'] === 'Industry Expert'">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                {!! Form::Select('Owner', $owners, null, [ 'v-model' => 'attendee["Owner"]', 'class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body text-right">
                        <button data-style="expand-left" type="button" @click="saveAttendee('attendee')" class="btn btn-raised btn-success ladda-button" ><span class="ladda-label">រក្សាទុក | Save</span><span class="ladda-spinner"></span><div class="ladda-progress" style="width: 0px;"></div></button>
                    </div>
                </div>
            </form>
        </div>
...
<div class="form-horizontal clearfix">
    <div class="widget">
        ...
        <div class="panel-body">
            <div class="col-md-12">
                <div class="form-group required" :class = "{'has-error': errors.has('items.Training Orginisation') }">
                    {!! Form::Label('Training Orginisation', 'Training Orginisation', ['class' => 'control-label col-lg-6']) !!}
                    <div class="col-lg-6">
                        {!! Form::Select('Training Orginisation', $organisations, null, [ 'v-model' => 'item["Training Orginisation"]' , 'data-vv-name'=>'items.Training Orginisation', 'v-validate' => "'required'" ,'required' => 'required','class' => 'form-control']) !!}
                    </div>
                </div> 
            ...
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table" id="tabletraining" style="border:1px solid #ddd">
                        <thead>
                ...
                save: function( ){
                    ...
                    this.$validator.validateAll().then((result) => {
                        if (result) {
                            ...
                            axios.post('{{ route('tot.store') }}', this.$data.item)
                            .then(function(response){
                                if(response.data.created){
                                    window.location = '{{ route('tot.index') }}';
                                }
                            }).catch(function (){
                                error => this.errors.record(error.reponse.data);
