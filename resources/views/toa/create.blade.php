            ...
            <form data-vv-scope="attendee">
                <div class="form-horizontal tot-modal-form panel-body">
                    ...
                    <div class="panel-body text-right">
                        <button type="button" data-style="expand-left" @click="saveAttendee('attendee')" class="btn btn-raised btn-success ladda-button"><span class="ladda-label">រក្សាទុក | Save</span><span class="ladda-spinner"></span><div class="ladda-progress" style="width: 0px;"></div></button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group required " :class = "{'has-error': errors.has('items.Training Orginisation') }">
                        ...
                        <div class="col-lg-6">
                            {!! Form::Select('Training Orginisation', $trainingProviders , null, [ 'v-model' => 'item["Training Orginisation"]', 'data-vv-name'=>'items.Training Orginisation', 'v-validate' => "'required'" , 'class' => 'form-control']) !!}
                        </div>
                    </div>
                ...
                save: function( ){
                    ...
                    this.$validator.validateAll().then((result) => {
                        if (result) {
                            ...
                            axios.post('{{ route('toa.store') }}', this.$data.item)
                            .then(function(response){
                                if(response.data.created){
                                    window.location = '{{ route('toa.index') }}';
                                }
                            }).catch(function (){
