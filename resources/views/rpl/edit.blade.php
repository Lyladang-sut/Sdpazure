...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-views" style="width: 45%;top:10%;background: #FFF">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="gridModalLabel">RPL Test</h4>
        </div>
        <div class="modal-content load-modal-form">
            <div class="form-horizontal tot-modal-form panel-body">
                ...
                <div class="panel-body text-right">
                    <button data-style="expand-left" type="button" class="btn btn-raised btn-success ladda-button"><span class="ladda-label" @click="saveTest" >រក្សាទុក | Save</span><span class="ladda-spinner"></span><div class="ladda-progress" style="width: 0px;"></div></button>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group required">
                        ...
                        <div class="col-lg-6">
                        {!! Form::date('Date of test', null, [ 'v-model' => 'item["Date of test"]', 'required' => 'required','class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-lg-6">
                        {!! Form::select('RPL provider', $providers , null, [ 'v-model' => 'item["RPL provider"]', 'required' => 'required','class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-lg-6">
                        {!! Form::select('Location', $locations , null, [ 'v-model' => 'item["Location"]', 'required' => 'required','class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-lg-6">
                        {!! Form::select('Assesment Sector', $sectors , null, [ 'v-model' => 'item["Assesment Sector"]', 'required' => 'required','class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-lg-6">
                        {!! Form::select('Course', $courses , null, [ 'v-model' => 'item["Course"]', 'required' => 'required','class' => 'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-lg-6">
                        {!! Form::select('Batch', $batches, null, [ 'v-model' => 'item["Batch"]', 'required' => 'required','class' => 'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                save: function( ){
                    ...
                    axios.put('{{ route('rpl.index') }}/' + this.item.ID, this.item)
